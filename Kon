...
if game.PlaceId == ALLOWED_PLACE_ID then
    ...
    FireForceTab:CreateDropdown({
        ...
        CurrentOption = { FF_QUEST_TYPES[1] },
        MultipleOptions = false,
