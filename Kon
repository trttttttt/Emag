...
if game.PlaceId == ALLOWED_PLACE_ID then
    ...
    -- Infernal Ambush only: direct teleport onto the enemy target, matching the original script.
    local function ambushTeleportAndKill(mob)
        local hrp = getHRP()
