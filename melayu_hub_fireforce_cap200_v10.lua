...
-- its own 200-stud pre-check before calling this function; other systems may use it
...
local FIRE_FORCE_CFRAME_CAP = 200
...
local CURRENT_ISLAND_SCAN_DISTANCE = 500
    ...
    local function runAmbushLoop()
        ...
        while ffActive do
            ...
            if target and isTargetOnCurrentIsland(target) and targetDistance <= FIRE_FORCE_CFRAME_CAP then
                -- Target is on the current island and within the 200-stud CFrame cap.
                ...
                -- Missing target OR target is farther than 200 studs: do NOT
